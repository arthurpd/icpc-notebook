...
/*
        Treap:
                A short self-balancing tree. It acts as a sequential
   container with log-time splits/joins, and is easy to augment with
                additional data.

        Time: O(log N) per operation.

        Constraints:
                Acts as a vector of size N, with positions in range [0,
   N-1].
        ...
        Usage:
                ...
                To augment with extra data you should mostly add stuff to
   the recalc function. (e.g. to make it work like a seg tree) See
   applications for more usage examples.
*/
namespace treap {
struct node {
  node *l = 0, *r = 0;
