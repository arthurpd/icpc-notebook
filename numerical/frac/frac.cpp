...
/*
        ...
        Usage:
                ...
                Be careful that the numerator and denominator might
   overflow if lcm is too big. In those cases, you can always do
   frac<big_int>, but that will be painful to code.
...
struct frac {
  ...
  bool operator<(const frac &rhs) const { return a * rhs.b < rhs.a * b; }
  ...
  frac operator-(void) const { return frac(-a, b); }
