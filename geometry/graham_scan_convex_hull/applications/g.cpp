...
vector<point<T> > CH(vector<point<T> > points){
	...
	for(auto p : points){
		//Trocar segunda comparacao pra <= para discartar pontos do meio de arestas no ch
		//Double: trocar segunda comparação por < EPS (descarta pontos em arestas)
...
int main(){
	...
	//Importante imprimir assim, double com uma casa da problema (exemplo: pontos (0,0);(1,1);(0,1)
