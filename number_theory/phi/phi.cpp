...
/*
	...
	Source: modified from https://cp-algorithms.com/algebra/phi-function.html
		and https://github.com/kth-competitive-programming/kactl/blob/master/content/number-theory/phiFunction.h
	...
	Usage:
		...
		- sum_{d|n} phi(d) = n
		- sum_{1 <= k <= n, gcd(k,n)=1} k = n * phi(n) / 2, for n > 1
*/
